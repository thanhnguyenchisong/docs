...
---
## 8. Service Portail support
- Branding Editor : Theme, color, icon config
- Designer: design your page
- Page Editor: edit page, container, row, column, widget
- Widget Editor: edit widget
- Portail Create : create a new portal
- Get Help